...
["我期待從這一梯得到出梯週，上一梯因為疫情的關係，所以沒有經歷過出梯週，不過在上梯的準備期也學到了很多東西；除了出梯週之外，我也期待我在這一梯看到的一個不一樣的自己，都活在自己的舒適圈，永遠不知道自己最大的能耐在哪。","為了達成我的目標，我能做的事有：一，祈禱疫情可以被控管住；二，每次打教案、做行政、開各種會都能夠盡自己當時最佳的力氣來去完成他。","n"],
["能從出梯中懂得學會付出、人際關係上的相處，以及換位思考都是相當重要的一環，雖然現在還無法真正完全體會，但我相信接下來的幾個月可以慢慢從中領悟。","有時間時就和大家多多相處、寫教案時或者試教時站在小朋友的立場多思考一點，期許自己能夠做到這兩點以達成目標","n"],
["我期待能夠在這次梯隊中看到學員的各種成長，以及對梯隊的熱忱。","提供我所能提供的幫助，多參與學員梯隊工作，對學員多了解一點，<br><br>才能夠給予適合學員個性的建議。","y"],
["我期待這一梯能用不同的身分出梯，當學員的時候幾乎整天都跟小朋友相處，現在換個角度，看著自己的學員去帶領一個班級，自己在旁邊輔助他們，希望自己跟學員一起成長！","多去問大的學年，如何帶領一個年級，且不論教案會、學年會要多講話","y"],
